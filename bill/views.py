...
class BudClassWiseSale(BillFilterDateMixin,ExportExcelMixin,ListView):
    template_name = "bill/report/bud_class_wise_sales.html"
    ...
    def get_processed_data(self):
        ...
        for bill in qs:
            for item in bill.bill_items.all():
                ...
                budclass = item.product.budclass.title
    ...
    def export_to_xls(self):
        response = HttpResponse(content_type="application/ms-excel")
        response["Content-Disposition"] = 'attachment; filename="BudClass_report.xls"'
