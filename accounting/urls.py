...
from .views import JournalEntryCreateView, JournalEntryView,  TrialBalanceView, ProfitAndLoss, BalanceSheet, DepreciationView, PartyLedgerView, LedgerDetailView, PartyLedgerJournalView, PartyLedgerJournal1View, SundryDebtorsLedgersView, SundryCreditorsLedgersView, JournalEntryUpdateView
from . import views
urlpatterns += [
