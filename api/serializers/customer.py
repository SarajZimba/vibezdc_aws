...
class BillSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        #     "transaction_miti"
        # ]
        fields = ["id","branch", "grand_total", "discount_amount", "payment_mode", "invoice_number", "agent_name", "date", "time"]

    def get_date(self, obj):
        return obj.transaction_date_time.date()
    
    def get_time(self, obj):
        return obj.transaction_date_time.time()
